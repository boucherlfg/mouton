...
public class RecipeMenuItem : MonoBehaviour
{
    ...
    public void UpdateRecipe(Recipe recipe) {
        result.GetComponent<Image>().sprite = recipe.outputs[0].GetComponent<SpriteRenderer>().sprite;
        ...
        for(int i = 0; i < recipe.inputs.Length; i++) {
            ...
            instance.GetComponent<Image>().sprite = input.GetComponent<SpriteRenderer>().sprite;
